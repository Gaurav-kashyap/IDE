    ...
    <div className="github-welcome">
      <Card className="github-welcome-content">
        <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'center' }}>
          <div>
            <H2>Welcome to Gaurav Zone with GitHub Classroom!</H2>
            <br />
            <H4>Gaurav Zone does not find any course information for this account.</H4>
            <div style={{ display: 'flex', justifyContent: 'center' }}>
              <UL style={{ textAlign: 'justify' }}>
                <li>
                  If you are enrolled in a Gaurav Zone course that uses GitHub Classroom, check
