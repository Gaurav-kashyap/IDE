...
const ContributorsDetails: React.FC = () => (
  <div className="outsideDetails">
    <Card className="contributorsDetails" elevation={Elevation.ONE}>
      <H3>The Team behind the Gaurav Zone</H3>
      <p className="description">
        The <i>Gaurav Zone</i> is designed and developed by a team of students, most of who have
        used the system to learn the fundamentals of computing and enjoyed it. This page includes
        all developers who contributed to the Gaurav Zone <i>Merlin</i> (2023) and its precursors{' '}
        <i>Rook</i> (2022), <i>Knight</i> (2020) and <i>Cadet</i> (2018). These versions succeeded
        Gaurav Zone 2 (2017) and ultimately the original Gaurav Zone (2016).
      </p>
      ...
      <div className="contributors">
        ...
        <p>
          ...
          <a href={Links.githubOrg}>GitHub repositories of the Gaurav Zone</a>. Feel free to join
          us!
        </p>
      </div>
    </Card>
