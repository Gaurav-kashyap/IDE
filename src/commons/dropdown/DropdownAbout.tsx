...
const DropdownAbout: React.FC<DialogProps> = props => (
  ...
  >
    <div className={Classes.DIALOG_BODY}>
      <div className="abt">
        <p>
          The <i>Gaurav Zone</i> is a computer-mediated learning environment for studying the
        ...
        <p>
          The Gaurav Zone is available under the Apache License 2.0 at the GitHub organisation{' '}
          <a href={Links.githubOrg}>source-academy</a>. More information and resources are available
          at the <a href={Links.about}>about pages</a> of the Gaurav Zone.
        </p>
      </div>
    </div>
  </Dialog>
